...
if VitalWatchLocale.optLocale then
	...
	VitalWatchLocale.SoundCritHealthByClass_Opt = "Sound - Others' Critical Health By Class"
	VitalWatchLocale.SoundCritHealthByClass_Desc = "Enable sounds which also tell you the class of the unit with critical health. This overrides all other sounds."
	VitalWatchLocale.SoundLowHealthByClass_Opt = "Sound - Others' Low Health By Class"
	VitalWatchLocale.SoundLowHealthByClass_Desc = "Enable sounds which also tell you the class of the unit with low health. This overrides all other sounds."
	VitalWatchLocale.MessageFrameHealth_Opt = "Choose Message Frame for Health"
	VitalWatchLocale.MessageFrameHealth_Desc = "Choose the Message Frame for showing health alerts."
	...
	VitalWatchLocale.SoundCritManaByClass_Opt = "Sound - Others' Critical Mana By Class"
	VitalWatchLocale.SoundCritManaByClass_Desc = "Enable sounds which also tell you the class of the unit with critical mana. This overrides all other sounds."

	VitalWatchLocale.MessageFrameMana_Opt = "Choose Message Frame for Mana"
	VitalWatchLocale.MessageFrameMana_Desc = "Choose the Message Frame for showing mana alerts."
	VitalWatchLocale.FlashFrameMana_Opt = "Enable Screen Flash for Mana"
	VitalWatchLocale.FlashFrameMana_Desc = "Enable the screen flash effect for mana, where the sides of the screen flash in a semi-transparent blue hue at a rate determined by the amount of mana below the set low mana threshold."
	...
	VitalWatchLocale.ColourAggroLost_Opt = "Message Frame Colour - Your Aggro Lost"
	VitalWatchLocale.ColourAggroLost_Desc = "Change the colour used for your lost aggro Message Frame alerts."
	VitalWatchLocale.ColourAggroLostOther_Opt = "Message Frame Colour - Other Aggro Lost"
	VitalWatchLocale.ColourAggroLostOther_Desc = "Change the colour used for other lost aggro Message Frame alerts."
	VitalWatchLocale.AggroWatch_Opt = "Watch Aggro Gained"
	VitalWatchLocale.AggroWatch_Desc = "Determine how/if we will report aggro gained for yourself, party, and raid members."
	VitalWatchLocale.AggroLostWatch_Opt = "Watch Aggro Lost"
	VitalWatchLocale.AggroLostWatch_Desc = "Determine how/if we will report aggro lost for yourself, party, and raid members."
	VitalWatchLocale.AggroNoWatchClass_Opt = "Ignore Class for Aggro"
	VitalWatchLocale.AggroNoWatchClass_Desc = "Ignore checking aggro gained/lost for certain classes."
	VitalWatchLocale.AggroNoWatchName_Opt = "Ignore Name for Aggro"
	VitalWatchLocale.AggroNoWatchName_Desc = "Ignore checking aggro gained/lost for certain players."
	VitalWatchLocale.AggroWatchRate_Opt = "Your Aggro Refresh Rate"
	VitalWatchLocale.AggroWatchRate_Desc = "Change the rate at which your own aggro (under attack) status is forcibly refreshed. Default is 5 seconds."
	VitalWatchLocale.AggroWatchOtherRate_Opt = "Others' Aggro Refresh Rate"
	VitalWatchLocale.AggroWatchOtherRate_Desc = "Change the rate at which aggro (under attack) status is forcibly refreshed. Default is 8 seconds."
	...
	VitalWatchLocale.MsgAggroLost_Opt = "Channel Message - Your Lost Aggro"
	VitalWatchLocale.MsgAggroLost_Desc = "Set the message sent out to the channel of your choice when you are no longer under attack."
	VitalWatchLocale.MsgAggroLostOther_Opt = "Channel Message - Others' Lost Aggro"
	VitalWatchLocale.MsgAggroLostOther_Desc = "Set the message sent out to the channel of your choice when others are no longer under attack."
	VitalWatchLocale.EmoteAggro_Opt = "Emote - Your Aggro"
	VitalWatchLocale.EmoteAggro_Desc = "Set the emote used when you are under attack. For voice or other builtin emotes, put / in front of the given emote command."
	VitalWatchLocale.EmoteAggroLost_Opt = "Emote - Your Lost Aggro"
	VitalWatchLocale.EmoteAggroLost_Desc = "Set the emote used when you are no longer under attack. For voice or other builtin emotes, put / in front of the given emote command."
	...
	VitalWatchLocale.SoundAggroByClass_Opt = "Sound - Aggro Gained Per Class"
	VitalWatchLocale.SoundAggroByClass_Desc = "Enable sounds which also tell you the class of the unit that gained aggro. This overrides all other sounds."
	VitalWatchLocale.SoundAggroLost_Opt = "Sound - Your Lost Aggro"
	VitalWatchLocale.SoundAggroLost_Desc = "Change the sound played when you are no longer under attack. Just give the root filename, do not add the extension (IE, leave out .wav). Additionally, do not give a path. Instead, put your sound in the sounds folder within VitalWatch's folder."
	VitalWatchLocale.SoundAggroLostOther_Opt = "Sound - Others' Lost Aggro"
	VitalWatchLocale.SoundAggroLostOther_Desc = "Change the sound played when someone else is no longer under attack. Just give the root filename, do not add the extension (IE, leave out .wav). Additionally, do not give a path. Instead, put your sound in the sounds folder within VitalWatch's folder."
	VitalWatchLocale.MessageFrameAggro_Opt = "Choose Message Frame for Aggro Alerts"
	VitalWatchLocale.MessageFrameAggro_Desc = "Choose the Message Frame to show aggro (under attack) alerts."
	VitalWatchLocale.FlashFrameAggro_Opt = "Enable Screen Flash for Aggro Gained"
	VitalWatchLocale.FlashFrameAggro_Desc = "Enable the screen flash effect for aggro, where the sides of the screen flash in a semi-transparent red or blue hue at a rate determined by the estimated number of attackers."
	...
	VitalWatchLocale.AggroMap = {
		[1] = "Player only in party or raid",
		[2] = "Player",
		[3] = "Player and Party",
		[4] = "Just Party, ignore Player",
		[5] = "Just Party and Raid, ignore Player",
		[6] = "All"
	}
	VitalWatchLocale.MessageFrameMap = {
		[1] = "Scrolling Combat Text",
		[2] = "Mik's Scrolling Battle Text",
		[3] = "Blizzard's Floating Combat Text (FCT)",
		[4] = "BigWigs Alert Frame"
	}
	VitalWatchLocale.FlashFrameMap = {
		[1] = "LowHealthFrame (Red)",
		[2] = "OutOfControlFrame (Blue)"
	}
	...
	-- Defaults
	VitalWatchLocale.Default = "VitalWatch's Default"
